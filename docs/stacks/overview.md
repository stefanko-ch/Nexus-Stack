...
| **[CyberChef](https://github.com/stefanko-ch/Nexus-Stack/blob/main/docs/stacks/cyberchef.md)** | `mpepping/cyberchef:v10.24.0` | GCHQ's "Cyber Swiss Army Knife" — drag-and-drop ~400 operations into a recipe (encode/decode/hash/regex/crypto/compress/parse). Fully client-side: nothing you paste leaves the browser. Perfect for decoding JWTs, base64+gzip payloads, or live-demoing format conversions in class. |
